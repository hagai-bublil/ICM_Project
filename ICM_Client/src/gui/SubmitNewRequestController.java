...
/**
 * This class is the controller of: SubmitNewRequestScreen and it contains all the methods that manage the screen
 *
 */
public class SubmitNewRequestController extends HomePageController implements IClient, Initializable {
	...
	/** The supervisor btn 1. */
	@FXML
	private Button supervisor_btn;

	/** The assessor btn 1. */
	@FXML
	private Button assessor_btn1;

	/** The executor btn 1. */
	@FXML
	private Button executor_btn1;
	...
	/** The notofication bnt 1. */
	@FXML
	private Button notofication_bnt1;

	/** The my account bnt 11. */
	@FXML
	private Button myAccount_bnt11;

	/** The requests btn 1. */
	@FXML
	private MenuButton requests_btn1;

	// @FXML
	// private MenuItem newRequest_btn1;

	// @FXML
	// private MenuItem ViewMyRequests_btn1;
...
/** The user name label. */
	 ...
	 */
	@FXML
	protected void myAccount_pressed(ActionEvent event) {
	 ...
	 */
	@FXML
	void LogoutPressed(ActionEvent event) {// logout
		...
		if (option.get() == ButtonType.OK) {
			...
			GuiManager.SwitchScene(SCREENS.login, (Stage)thisNode.getScene().getWindow());
